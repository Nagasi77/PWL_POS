...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button onclick="modalAction('{{ url('barang/import') }}')" class="btn btn-sm btn-info mt-1" style=" border:0cm" >
                <i class=""></i>Import EXC
            </button>
            <a href="{{ url('/barang/export_excel') }}" class="btn btn-sm btn-primary mt-1" style="background-color: rgb(0, 90, 30); border:0cm">
